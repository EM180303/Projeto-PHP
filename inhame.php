    ...
    <div class="row">
      ...
      <br>
        <div class="card" style="width: 18rem;">
          ...
          <div class="card-body">
            <h5 class="card-title">Inhame</h5>
            <p class="card-text">R$ 9,50 Kg</p>
            <p id="valortotal"> Valor a ser pago: R$ 9,50</p>
            <p>Quantidade:</p>
            <input class="btn btn-secondary" placeholder="Adicione a quantidade" type="number" id="inhame" onblur="valorProduto();">
