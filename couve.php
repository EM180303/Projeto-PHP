        ...
        <div class="card" style="width: 18rem;">
          ...
          <div class="card-body">
            <form action="sucesso.php" method="POST">
              <h5 class="card-title"><input name="produto" type="text" value="Couve-Flor"></h5>
              <p class="card-text">Valor por unidade R$: <input name="valor" type="text" value="10.99"></p>
              <p id="valortotal"> Valor a ser pago: R$ 0.00</p>
              <p>Quantidade:</p>
              <input name="quantidade" class="btn btn-secondary" placeholder="Adicione a quantidade" type="number" id="couve" onblur="valorProduto();">
