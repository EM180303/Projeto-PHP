    ...
    <div class="row">
      ...
      <br>
        <div class="card" style="width: 18rem;">
          ...
          <div class="card-body">
            <h5 class="card-title">Uva Roxa</h5>
            <p class="card-text">R$ 8,50 Kg</p>
            <p id="valortotal"> Valor a ser pago: R$ 8,50</p>
            <p>Quantidade:</p>
            <input class="btn btn-secondary" placeholder="Adicione a quantidade" type="number" id="uva" onblur="valorProduto();">
