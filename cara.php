...
<head>
   ...
   function valorProduto(){
     var total = 0;
     var num = document.getElementById("cara").value;
     total = 4.29 * num;
    ...
    <div class="row">
      ...
      <br>
        <div class="card" style="width: 18rem;">
          ...
          <div class="card-body">
            <h5 class="card-title">Cará São Tomé</h5>
            <p class="card-text">R$ 4,29 Kg</p>
            <p id="valortotal"> Valor a ser pago: R$ 4,29</p>
            <p>Quantidade:</p>
            <input class="btn btn-secondary" placeholder="Adicione a quantidade" type="number" id="cara" onblur="valorProduto();">
