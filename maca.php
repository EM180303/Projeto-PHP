        ...
        <div class="card" style="width: 18rem;">
          ...
          <div class="card-body">
            <form action="sucesso.php" method="POST">
              <h3 class="card-title">Maçã Gala</h3>
              <input name="produto" type="hidden" value="Maçã Gala">
              <p class="card-text">Valor por unidade R$: 0.80</p>
              <input name="valor" type="hidden" value="0.80">
              <p id="valortotal"> Valor a ser pago: R$ 0.00</p>
              <p>Quantidade:</p>
              <input name="quantidade" class="btn btn-secondary" placeholder="Adicione a quantidade" type="number" id="maca" onblur="valorProduto();">
