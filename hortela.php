        ...
        <div class="card" style="width: 18rem;">
          ...
          <div class="card-body">
            <form action="sucesso.php" method="POST">
              <h3 class="card-title">Hortelã</h3>
              <input name="produto" type="hidden" value="Hortelã">
              <p class="card-text">Valor por unidade R$: 3.50</p>
              <input name="valor" type="hidden" value="3.50">
