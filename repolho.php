        ...
        <div class="card" style="width: 18rem;">
          ...
          <div class="card-body">
            <form action="sucesso.php" method="POST">
              <h3 class="card-title">Repolho</h3>
              <input name="produto" type="hidden" value="Repolho">
              <p class="card-text">Valor por Kg R$: 6.50</p>
              <input name="valor" type="hidden" value="6.50">
              <p id="valortotal"> Valor a ser pago: R$ 0.00</p>
              <p>Quantidade:</p>
              <input name="quantidade" class="btn btn-secondary" placeholder="Adicione a quantidade" type="number" id="repolho" onblur="valorProduto();">
